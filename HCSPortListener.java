...
// listen to HCSPorts. The portEvent() method is called whenever some
// data is available on the port. HCSPortListener classes must be
// matched with an appropriate HCSPort class.
public interface HCSPortListener
{
	public void portEvent();
	public void portErrorEvent(int errorType);
	public void acquire() throws HCSException;
